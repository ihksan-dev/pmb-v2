<?php
$title = "Formulir Pendaftaran - SIPMB v1.5";
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control" id="gender" name="gender" required>
                                    ...
                                    <option value="L" <?php echo (($_POST['gender'] ?? '') === 'L') ? 'selected' : ''; ?>>Laki-laki</option>
                                    <option value="P" <?php echo (($_POST['gender'] ?? '') === 'P') ? 'selected' : ''; ?>>Perempuan</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control" id="birth_date" name="birth_date" value="<?php echo htmlspecialchars($_POST['birth_date'] ?? ''); ?>" required>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control" id="province_id" name="province_id" required>
                                    ...
                                    <?php foreach ($provinces as $province): ?>
                                        <option value="<?php echo $province['id']; ?>" <?php echo (($_POST['province_id'] ?? '') == $province['id']) ? 'selected' : ''; ?>>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control" id="regency_id" name="regency_id" required>
                                    ...
                                    <?php if (!empty($_POST['province_id'])): ?>
                                        <?php foreach ($regencies as $regency): ?>
                                            <option value="<?php echo $regency['id']; ?>" <?php echo (($_POST['regency_id'] ?? '') == $regency['id']) ? 'selected' : ''; ?>>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control" id="prodi_id" name="prodi_id" required>
                            ...
                            <?php foreach ($prodis as $prodi): ?>
                                <option value="<?php echo $prodi['id']; ?>" <?php echo (($_POST['prodi_id'] ?? '') == $prodi['id']) ? 'selected' : ''; ?>>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control" id="academic_year_id" name="academic_year_id" required>
                            ...
                            <?php foreach ($academic_years as $year): ?>
                                <option value="<?php echo $year['id']; ?>" <?php echo (($_POST['academic_year_id'] ?? '') == $year['id']) ? 'selected' : ''; ?> <?php echo $year['is_active'] ? 'selected' : ''; ?>>
